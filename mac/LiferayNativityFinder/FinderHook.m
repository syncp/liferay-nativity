...
+ (void)install
{
    ...
    //Replacing TListViewIconAndTextCell with TColumnCell to handle 10.10
...
+ (void)uninstall
{
	...
	// Icons
	[self hookMethod:@selector(IconOverlayHandlers_IKImageBrowserCell_drawImage:) inClass:@"IKImageBrowserCell" toCallToTheNewMethod:@selector(drawImage:)]; // 10.7 & 10.8 & 10.9
